...
A Progressive Web App that generates tactically interesting D&D 4th Edition encounters for optimized parties. Instead of XP budgets, it uses encounter templates, monster role composition, weighted random selection, and multi-candidate scoring to produce encounters that feel like a GM assistant — not a random monster picker.
...
- **978 monsters** from official 4e sources (Monster Manual, DMG, Draconomicon, Dark Sun, etc.) with role, rank, level, and tag data
